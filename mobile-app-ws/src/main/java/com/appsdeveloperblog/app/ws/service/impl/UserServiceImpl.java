...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto user) {
		...
		//loop through UserDto object to list of address
		...
		// set UserEntity UserId, Userpassword
	...
	public boolean requestPasswordReset(String email) {
		...
		String token = new Utils().generatePasswodResetToken(userEntity.getUserId());
